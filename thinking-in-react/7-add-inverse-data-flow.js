/*
Create a function on FilterableProductTable called handleUserInput.
Pass that as a prop to SearchBar. On the SearchBar,
add an onChange handler to the inputs.

Use this handler to determine the current state and set the state by
invoking handleUserInput via props.
